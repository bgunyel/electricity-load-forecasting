...
def main():
    ...
    fetch_and_add_new_weather_data(geo_unit_code=GeographicalUnitCode.TURKIYE,
                                   regulator=RegulatorType.EPIAS,
                                   start_date=datetime.date(year=2015, month=1, day=3),
                                   end_date=datetime.date(year=2015, month=1, day=5))
